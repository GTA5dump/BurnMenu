...
bool Menu::Bool(const char * option, bool & b00l)
{
	...
	if (b00l)
	{
		if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
			...
			Drawing::Spriter("commonmenu", b00l ? "shop_box_cross" : "shop_box_blank", (Settings::menuX + 0.078f), (Settings::optionCount * 0.035f + 0.142f), 0.03f, 0.05f, 0, 255, 255, 255, 255);
		else if (Settings::optionCount > Settings::currentOption - Settings::maxVisOptions && Settings::optionCount <= Settings::currentOption)



			Drawing::Spriter("commonmenu", b00l ? "shop_box_cross" : "shop_box_blank", (Settings::menuX + 0.078f), ((Settings::optionCount - (Settings::currentOption - 16))* 0.035f + 0.142f), 0.03f, 0.05f, 0, 255, 255, 255, 255);
	}
	else
	{
		if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
